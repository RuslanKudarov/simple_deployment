...
def run():
    ...
    if add_selectbox == "Online":
        ...
        Facultet = st.selectbox("Факультет", ["Транспортное строительство (Факультет)",
                                              ...
                                              "Автоматизация и интеллектуальные технологии (Факультет)",
        ...
        NapravleniePodgotovki = st.selectbox("Направление подготовки",
                                             ...
                                             index = 0)
        SrokObucheniya = st.radio("Срок обучения", ["5 лет", "4 года", "5,5 лет", "6 лет"],
                                  index = 0, help = "планируемый срок обучения по образовательной программе в университете")
        Obrazovanie = st.selectbox("Полученное образование",
                                   ["",

...
def run():
    ...
    if add_selectbox == "Online":
        ...
        Facultet = st.radio("Факультет", ["Автоматизация и интеллектуальные технологии (Факультет)",
        ...
        if Facultet == "Экономика и менеджмент (Факультет)":
            ...
            if NapravleniePodgotovki == "":
                ...
                SrokObucheniya = st.radio("Срок обучения по направлению подготовки", ["4 года"],

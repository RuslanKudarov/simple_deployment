...
def run():
    ...
    if add_selectbox == "Online":
        ...
        Facultet = st.selectbox("Факультет", ["Автоматизация и интеллектуальные технологии (Факультет)",
                                ...
                                index = 0, help = "выберите факультет из раскрывающегося списка")
        
        NapravleniePodgotovki = st.selectbox("Направление подготовки",
                                             [""], index = 0, disabled = True,
                                             help = "для выбора направления подготовки укажите факультет")

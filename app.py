...
def run():
    ...
    if add_selectbox == "Online":
        ...
        SrokObucheniya = st.radio("Срок обучения по направлению подготовки", ["5 лет", "4 года", "5,5 лет", "6 лет"],
                                  index = 0)
        Obrazovanie = st.selectbox("Полученное образование до поступления в университет",
                                   ["",
                                    ...
                                    index = 0)
        SrBallDokObr = st.number_input('Средний балл док-та о довузовском образовании',
